...
class _MyHomePageState extends State<MyHomePage> {
  int _counter = 0;
  late Box<RegisterModel> box;
  late List<RegisterModel> data = [];

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    box = Hive.box<RegisterModel>("register");
  }

  void _incrementCounter() {
    box.add(RegisterModel(
            ...
            TextButton(
                onPressed: () {
                  data = box.values
                      .cast<RegisterModel>()
                      .toList()
                      .where((element) => element.email == "hhhhh@gmail.com")
                      .toList();
